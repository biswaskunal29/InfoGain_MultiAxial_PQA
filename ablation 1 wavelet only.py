...
def save_image_vit_enc(uid,imgid,new_dir):
    enc = get_image_vit_enc(uid,imgid, wavelet = 1, rgb = 0, way1 = 1, way2 = 0)
#    print(enc.shape)
    filename = uid + '_' + imgid + part1 + '.npy'
    filepath = new_dir / filename
    np.save(filepath, enc)
    
def save_image_text_enc(uid,imgid,new_dir, infobert = 0):
...
def save_dp_vit_enc(uid,imgid,new_dir,wavelet = 1, rgb = 0, way1 = 1, way2 = 0):
...
def save_banner_vit_enc(uid,imgid,new_dir,wavelet = 1, rgb = 0, way1 = 1, way2 = 0):
...
def save_profile_text_enc(uid,imgid,new_dir, infobert = 0):
...
FOLDER = r'E:\CVPR 23\Datasets\Our Dataset 5 Class\Ablation 2 wavelet and way1 on'
