...
#        y = np.load('y_train_v3.npy')
        ...
        X_double = np.load('abl_infobertonly_X_train_30split.npy')
        X = X_double.astype(np.single)
        y_double = np.load('abl_infobertonly_y_train_30split.npy')
...
#        y = np.load('y_test_v3.npy')
        ...
        X_double = np.load('abl_infobertonly_X_test_30split.npy')
        X = X_double.astype(np.single)
        y_double = np.load('abl_infobertonly_y_test_30split.npy')
        y = y_double.astype(np.single)
