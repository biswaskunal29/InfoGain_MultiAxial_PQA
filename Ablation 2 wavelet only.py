...
def save_image_vit_enc(uid,imgid,new_dir):
    ...
    enc = get_image_vit_enc(uid,imgid, wavelet = 1, rgb = 0, way1 = 0, way2 = 0)
#    print(enc.shape)
...
def save_dp_vit_enc(uid,imgid,new_dir):
    ...
    enc = get_dp_vit_enc(uid,imgid, wavelet = 1, rgb = 0, way1 = 0, way2 = 0)
#    print(enc.shape)
...
def save_banner_vit_enc(uid,imgid,new_dir):
    ...
    enc = get_banner_vit_enc(uid,imgid, wavelet = 1, rgb = 0, way1 = 0, way2 = 0)
#    print(enc.shape)
