...
def save_image_vit_enc(uid,imgid,new_dir):
    enc = get_image_vit_enc(uid,imgid,rgb = 0, way1 = 0, way2 = 0)
#    print(enc.shape)
...
def save_dp_vit_enc(uid,imgid,new_dir,rgb = 0, way1 = 0, way2 = 0):
...
def save_banner_vit_enc(uid,imgid,new_dir,rgb = 0, way1 = 0, way2 = 0):
...
FOLDER = r'E:\CVPR 23\Datasets\Our Dataset 5 Class\Ablation 11 wavelet only'
