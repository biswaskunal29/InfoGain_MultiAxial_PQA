...
def save_image_vit_enc(uid,imgid,new_dir):
    ...
    enc = get_image_vit_enc(uid,imgid, wavelet = 1, rgb = 0, way1 = 1, way2 = 1)
#    print(enc.shape)
...
def save_dp_vit_enc(uid,imgid,new_dir):
    ...
    enc = get_dp_vit_enc(uid,imgid, wavelet = 1, rgb = 0, way1 = 1, way2 = 1)
#    print(enc.shape)
...
def save_banner_vit_enc(uid,imgid,new_dir):
    ...
    enc = get_banner_vit_enc(uid,imgid, wavelet = 1, rgb = 0, way1 = 1, way2 = 1)
#    print(enc.shape)
...
FOLDER = r'E:\CVPR 23\Datasets\Our Dataset 5 Class\Ablation 3 wavelet way1 way2 on'
