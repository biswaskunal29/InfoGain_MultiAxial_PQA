...
def save_image_vit_enc(uid,imgid,new_dir):
    ...
    enc = get_image_vit_enc(uid,imgid, wavelet = 0, rgb = 1, way1 = 0, way2 = 0)
#    print(enc.shape)
...
def save_image_text_enc(uid,imgid,new_dir):
    ...
    enc = get_image_text_enc(uid,imgid, infobert = 1)
#    print(enc.shape)
...
def save_dp_vit_enc(uid,imgid,new_dir):
    ...
    enc = get_dp_vit_enc(uid,imgid, wavelet = 0, rgb = 1, way1 = 0, way2 = 0)
#    print(enc.shape)
...
def save_banner_vit_enc(uid,imgid,new_dir):
    ...
    enc = get_banner_vit_enc(uid,imgid, wavelet = 0, rgb = 1, way1 = 0, way2 = 0)
#    print(enc.shape)
...
def save_profile_text_enc(uid,imgid,new_dir):
    ...
    enc = get_profile_text_enc(uid,imgid, infobert = 1)
#    print(enc.shape)
...
FOLDER = r'E:\CVPR 23\Datasets\Our Dataset 5 Class\Ablation 7 RGB and infobert only'
