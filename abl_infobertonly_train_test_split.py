...
full_X = np.load('abl infobert only_X_data.npy')
full_y = np.load('abl infobert only_y_data.npy')
...
np.save('abl_infobertonly_X_train_30split.npy', X_train)
np.save('abl_infobertonly_X_test_30split.npy', X_test)
np.save('abl_infobertonly_y_train_30split.npy', y_train)
np.save('abl_infobertonly_y_test_30split.npy', y_test)
# =============================================================================
