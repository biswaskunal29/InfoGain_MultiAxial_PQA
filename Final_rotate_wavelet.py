...
def image_encoding(file, wavelet = 1, rgb = 1, way1 = 1, way2 = 1):
    readfile = file
    ...
    for i in range(2):
        LL, (LH, HL, HH) = pywt.dwt2(img_rotation_collection[i], 'bior1.3')
        img_wavelet_hh.append(HH)
        img_wavelet_ll.append(LL)
     
#    print(type(img_wavelet_hh[0]))
...
#    small_collage = cv2.resize(collage1, (1024, 512))
#    
#    cv2.imshow("Final Collage 1",small_collage)
#    print(collage1.shape)
    ...
    small_collage = cv2.resize(collage2, (1440, 720))
    
#    cv2.imwrite("collage on circle.jpg", small_collage)
#    cv2.imshow("Diagonal",img_wavelet_hh[1])
#    cv2.imwrite("diagonal image.jpg", img_wavelet_hh[1])
#    cv2.imshow("approx",img_wavelet_ll[1])
#    cv2.imwrite("approx image.jpg", img_wavelet_ll[1])
    
    
    cv2.imshow("Final Collage 1",small_collage)
    
    #cv2.imshow("Final Collage 2",collage2)
...
#    enc = image_encoding("96573740_36 neur.jpg")
    enc = image_encoding("small_circle.jpg")
#    print(enc.shape)
#    print(enc[100])
#    print(enc[1060])
#    print(enc[2120])
...
# =============================================================================
# coeffs = pywt.dwt2(img_rotation_collection[4], 'bior1.3')
# LL1, (LH1, HL1, HH1) = coeffs
# cv2.imshow("Trial image", img_rotation_collection[4])
# #cv2.imshow("Trial imagell", LL1)
# cv2.imshow("Trial imagelh", LH1)
# cv2.imshow("Trial imagehl", HL1)
# #cv2.imshow("Trial imagehh", HH1)
# =============================================================================



# =============================================================================
# rerotated_grey_22 = imutils.rotate_bound(rotated_grey_22, 22.5)
# cv2.imshow("re Rotated Image", rerotated_grey_22)
# 
# crop_rerotated_grey_22 = crop(rerotated_grey_22)
# cv2.imshow("crop re Rotated Image", crop_rerotated_grey_22)
# =============================================================================
